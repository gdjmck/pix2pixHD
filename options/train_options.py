...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--netD', type=str, default='NLayerDiscriminator',
                                 choices=['NLayerDiscriminator', 'NLayerRegressHeadDiscriminator'],
                                 help='class name of the discriminator')
